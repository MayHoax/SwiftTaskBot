...
'/currency - получить курс валют',
'/translate - перевод текста на другой язык',
...
async def start_cmd(message: types.Message):
    try:
        ...
        messages[username] = []
        await message.answer("Hello, I'm bot powered on API GPT-3.5 turbo. How can I help ? Use /commands for details")
